...
module.exports = (app) => {
  ...
  route.post(
    '/akunBCA',
    authenticationMiddleware,
    celebrate(usersValidator.buatAkunBCA),
    usersControllers.bikinAkunBCA
  );

  route.get(
    '/rekening/:id',
    authenticationMiddleware,
    usersControllers.getRekeningAkun
  );
  route.put(
    '/akunBCA/:id',
    authenticationMiddleware,
    celebrate(usersValidator.updatePIN),
    usersControllers.updatePINBCA
  );

  route.delete(
    '/akunBCA/:id',
    authenticationMiddleware,
    usersControllers.deleteAkunBCA
  );
};
